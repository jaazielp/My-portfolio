...
export function Services() {
    ...
    return (
        <section className="contanier mx-auto my-12 max-w-4xl p-4">
            <div className="p-4 text-center">
                ...
                <p className="text-sm text-gray-600">Posso atender uma gama completa de serviços, do front-end ao back-end com banco de dados e sistemas</p>
            </div>
