  ...
  const projects = [
    {
      ...
      link: "https://dev-llinks.netlify.app/",
      colSpan: "col-span-1",
    },
    {
      title: "Shorts Summary",
      description: "Esse projeto extrai o audio de um Shorts do youtube utilizando inteligência artificial",
      image:
      ...
      link: "https://short-summary.netlify.app/",
      colSpan: "col-span-1 md:col-span-2",
    },
    {
      title: "Shopping car",
      description: "Projeto realizado com React js utilizando a API do Mercado Livre.",
      image:
      ...
      link: "https://shopping-crt.netlify.app/",
      colSpan: "col-span-1",
    },
    {
      title: "Spotify",
      description: "Interface do Spotify versão Desktop feito com HTML e CSS.",
      image:
      ...
      link: "https://spotifycne.netlify.app/",
      colSpan: "col-span-1",
    },
    {
      title: "My Portfólio",
      description: "Projeto realizado com React js e TypeScript",
      image:
  ...
  return (
    <>
        <section className="rounded-tl-[80px] bg-gradient-to-tr from-black to-gray-900 text-white md:rounded-tl-[180px]">
            <div className="contanier mx-auto max-w-4xl p-4 oy-12">
                <div className="relative p-4 text-center">
                    ...
                    <p className="relative text-sm text-gray-400">Alguns dos projetos pessoais e que já realizei ao longo da trajetória como Desenvolvedor Front-end.</p>
                        ...
                        projects.map((project, index) => (
                          ...
                          style={{ backgroundImage: `url('${project.image}')` }} >
                            ...
                            <div className="absolute inset-0 flex h-full w-full flex-col items-center justify-center rounded-lg bg-blue-600 text-white opacity-0 transition-opacity group-hover:opacity-100">
                                ...
                                <a href={project.link} target="_blank"> <HiArrowTopRightOnSquare className="h-6w-6" />
                                </a>
                             </div>
                          </div>  
                        ))
