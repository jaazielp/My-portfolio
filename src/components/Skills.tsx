...
export default function Skills() {
  const educations = [
    {
      name: "Curso de Desenvolvimento Web, Discover | Rocketseat",
    },
    {
      name: "Curso sobre o uso de inteligência artificial | NLW IA | Rocketseat",
    },
    {
      name: "Análise e Desenvolvimento de Sistemas | Faculdade | Unicessumar"
    },
  ]
